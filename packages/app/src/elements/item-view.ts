...
import { VaultItemID, Field, FieldDef, FIELD_DEFS, VaultItem, AuditType } from "@padloc/core/src/item";
    ...
    private async _showHistoryEntry(historyIndex: number) {
        ...
        if (shouldRestore) {
            await app
                ...
                .then(async () => await auditVault(true));
                ...
                <header class="padded animated">
                    <div class="start-aligning horizontal layout">
                        ...
                        <div class="horizontal layout" ?hidden=${this._editing}>
                            ...
                            <pl-button class="slim transparent" @click=${() => this.edit()} .label=${$l("Edit")}>
